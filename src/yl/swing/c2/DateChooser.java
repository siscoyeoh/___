...
//      this.add(toSelect,BorderLayout.EAST);  
    ...
    private class JP4 extends JPanel{  
		private static final long serialVersionUID = 8226066084994028880L;
		public JP4(){  
            super(new BorderLayout());  
            this.setPreferredSize(new Dimension(295,20));  
            this.setBackground(new Color(160,185,215));  
    ...
    public static void main(String[] args) {  
        final DateChooser dateChooser = new DateChooser("yyyy-MM-dd");  
        JFrame jf = new JFrame("测试日期选择器");  
        jf.add(dateChooser, BorderLayout.CENTER);  
