...
public class JavaTelnet2 implements Runnable, TelnetNotificationHandler {
	static TelnetClient tc = null;
	static String charset = "utf-8";
	static String remoteip = "64.62.142.154";

	public static void main(String[] args) throws Exception {
		FileOutputStream fout = null;

		remoteip = "192.168.8.115";
		remoteip = "192.168.8.1";
//		remoteip = "192.168.8.44";
		...
		while (true) {
			...
			try {
				...
				Thread reader = new Thread(new JavaTelnet2());
				tc.registerNotifHandler(new JavaTelnet2());
				...
				do {
					try {
						...
						if (ret_read > 0) {
							//final String line = new String(buff, 0, ret_read); // deliberate
																				// use
																				// of
																				// default
																				// charset
							final String line = new String(buff, 0, ret_read, charset);
	...
	public void receivedNegotiation(int negotiation_code, int option_code) {
		...
		case TelnetNotificationHandler.RECEIVED_WONT:
			...
			break;
		/*
		 * case TelnetNotificationHandler.RECEIVED_COMMAND: command = "COMMAND";
		 * break;
		 */
		default:
