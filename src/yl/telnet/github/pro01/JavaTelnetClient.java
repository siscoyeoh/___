...
//https://github.com/lbw100/JavaTelnetClient/blob/master/JavaTelnetClient.java
...
public class JavaTelnetClient {
    ...
    public JavaTelnetClient(String server, String user, 
    		String password, String prompt, boolean mode) throws IOException {
...
//        write(password);
    ...
    public JavaTelnetClient(String server, String user, 
    		String password, String prompt, Integer timeout) throws IOException {
