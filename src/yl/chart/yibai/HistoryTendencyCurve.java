...
public class HistoryTendencyCurve extends ApplicationFrame {
	private static final long serialVersionUID = 7607528456862066357L;

	public HistoryTendencyCurve(final String title) {
		super(title);
...
//				current = (Minute) current.next();
	...
	public static void main(final String[] args) {
		...
		final HistoryTendencyCurve demo = new HistoryTendencyCurve(title);
		demo.pack();
